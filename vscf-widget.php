...
class vscf_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<input class="widefat" id="<?php echo $this->get_field_id( 'vscf_attributes' ); ?>" name="<?php echo $this->get_field_name( 'vscf_attributes' ); ?>" type="text" placeholder="<?php esc_attr_e( 'Example', 'very-simple-contact-form' ); ?>: email_to=&quot;info@example.com&quot;" value="<?php echo esc_attr( $vscf_attributes ); ?>"></p>
